...
Route::get('/categories/{id}', 'api\CategoriesController@readCategory')->middleware('auth:api');
...
Route::get(
    '/category/movies/{id}',
    'api\CategoryMoviesController@readCategoryMovie'
)->middleware('auth:api');
...
Route::get('/rentals/{id}', 'api\RentalsController@readRental')->middleware('auth:api');
...
Route::get(
    '/movie/rentals/{id}',
    'api\MovieRentalsController@readMovieRental'
)->middleware('auth:api');
...
Route::get('/users/{id}', 'api\UsersController@readUser')->middleware('auth:api');
