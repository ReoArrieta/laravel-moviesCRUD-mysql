...
Route::get('/movies/{id}', 'api\MoviesController@readOne')->middleware('auth:api');
...
Route::get('/categories/{id}', 'api\CategoriesController@readOne')->middleware('auth:api');
...
Route::get('/category/movies/{id}', 'api\CategoryMoviesController@readOne')->middleware('auth:api');
...
Route::get('/rentals/{id}', 'api\RentalsController@readOne')->middleware('auth:api');
...
Route::get('/movie/rentals/{id}', 'api\MovieRentalsController@readOne')->middleware('auth:api');
...
Route::get('/users/{id}', 'api\UsersController@readOne')->middleware('auth:api');
